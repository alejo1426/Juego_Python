...
fondo = pygame.image.load('imagenes/bosque.png')
...
enemigos.append(EnemyZ3(ANCHO / 2, 100))
...
def mostrar_mensaje_nivel_completado():
    ...
    while ventana_nivel:
        ...
        texto_continuar = FUENTE.render("Presiona ENTER para ir al Nivel 4", True, "yellow")
                ...
                if active:
                    if evento.key == pygame.K_RETURN:
                        ...
                        with open('puntuaciones.txt', 'a') as archivo:
                            archivo.write(f"{text} - {puntos} - {'Alcanzo Nivel 3'}\n")
...
while jugando:
    ...
    if pygame.time.get_ticks() - ultima_aparicion_enemigos > tiempo_entre_enemigos:
        ...
        enemigos.append(EnemyZ3(x_pos, -100))
